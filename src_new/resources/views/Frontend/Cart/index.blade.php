                    ...
                    <div class="box box--no-padding">
                        ...
                        <div class="box__body">
                            <table class="table table--listing table--checkout">
                                <thead>
                                    <tr>
                                        <th class="items0count" colspan="2">Sản phẩm trong giỏ hàng: <span class="badge">{{ \Cart::content()->count() }}</span></th>
                                    ...
                                    <tr>
                                        <td class="items0count" colspan="2">
                                            <a href="{{ route('detailProducts', [ app('ClassCommon')->formatText($row->name), $row->id ]) }}">{{ $row->name }}</a>
                                        </td>
