...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_vue_multiselect__ = __webpack_require__(956);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    data: function data() {
        return {
            ...
            options: [{
                ...
                subCategory: [{ name: 'Vue.js', id: 'Front-end' }, { name: 'Adonis', id: 'Backend' }]
            }, { name: '222222', id: '2222222' }],
            category: []
        };
    },
    ...
    mounted: function mounted() {
        ...
        axios.get('/news/id/' + this.$route.params.newsId).then(function (response) {
                  ...
                  [
                    _c(
                      "vue-form",
                      {
                        attrs: {
                          state: _vm.formstate,
                          action: "/#/news/edit/" + _vm.$route.params.newsId,
                          method: "post"
                        },
                        on: {
                                  ...
                                  _c("div", { staticClass: "input-group" }, [
                                    ...
                                    _c("input", {
                                      ...
                                      attrs: {
                                        id: "thumbnail",
                                        placeholder:
                                          "Click nút bên cạnh để chọn hình ảnh, hoặc paste đường dẫn hình ảnh vào đây",
                                        type: "text",
                                        name: "filepath"
                                      },
...
var update = __webpack_require__(34)("fb8016bc", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7dcb73ec\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7dcb73ec\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
