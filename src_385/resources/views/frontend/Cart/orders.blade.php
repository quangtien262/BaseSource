            ...
            <div class="content">
                <div class="box">
                    <div class="box__header">
                        <h2 class="box__title">Đặt hàng nhanh</h2>
                        <a href="/checkout-step-1" class="btn btn--back visible-xs visible-sm"><i class="fa fa-angle-left"></i></a>
                    </div>
                    <div class="box__header">
                        <p class="des05">
                            @if(!\Auth::check())
                                <em>Bạn đã có tài khoản? Click 
                                    <a  onclick="loadUrl('{{ route('login2Frontend') }}', '.modal-content')" data-toggle="modal" data-target="#myModal">Vào đây</a>
                                    để đăng nhập. Hoặc
                                    <a onclick="loadUrl('{{ route('register2Frontend') }}','.modal-content')" data-toggle="modal" data-target="#myModal">đăng ký</a>
                                    Thành viên để được hỗ trợ tốt nhất</em>
                            @endif
                        </p>
                    </div>
                        ...
                        <div class="row">							
                            <div class="col-md-12">
                                <div class="address-box " style="min-height: 40px;padding: 15px;">
                                    <div>
                                        <label>
                                            Vui xác nhận thông tin liên hệ theo mẫu bên dưới, chúng tôi sẽ liên hệ với bạn trong vòng 24h
                                        </label>
                                    </div>
                                    <div>
                                        Mọi thắc mắc của quý khách có thể liên hệ qua hotline:
                                        <a href="tel:{{ $config->phone }}"><b class="_red">{{ $config->phone }}</b></a>
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-group-lg  has-feedback">
                                            ...
                                            <div>
                                                <input type="text"
                                                       ...
                                                       <i class="form-control input-sm-feedback" 
                                                            data-fv-icon-for="address[0][name]" 
                                                            style="display: none; pointer-events: none;"></i>
                                            </div>
                                        ...
                                        <div class="form-group form-group-lg">
                                            ...
                                            <div class="radio-list">
                                                <select id="address_type_0" name="address_type" class="form-control input-sm" tabindex="9">
                                        ...
                                        <div class="form-group form-group-lg has-feedback">
                                            ...
                                            <div>
                                                <textarea type="text" 
                                                          ...
                                                          value="" 
                                                          data-fv-field="address">{{ $user->address or '' }}</textarea>
                                                <i class="form-control input-sm-feedback" data-fv-icon-for="address" style="display: none; pointer-events: none;"></i>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group form-group-lg  has-feedback">
                                            ...
                                            <div>
                                                <input type="text" 
                                                       ...
                                                       value="{{ $user->phone or '' }}" 
                                                       data-fv-notempty="true" 
                                                       data-fv-notempty-message="Số điện thoại của bạn" 
                                                       data-fv-field="phone">
                                                <i class="form-control input-sm-feedback" data-fv-icon-for="phone" style="display: none; pointer-events: none;"></i>
                                            </div>
                                        ...
                                        <div class="form-group form-group-lg has-feedback">
                                            <label for="ward_0" class="control-label">Địa chỉ Email</label>
                                            <div>
                                               <input type="text" 
                                               required="required"
                                                       class="form-control input-sm validate[custom[phone]]" 
                                                       ...
                                                       value="{{ $user->email or '' }}" 
                                                       data-fv-notempty="true" 
                                                       data-fv-notempty-message="Địa chỉ email của bạn" 
                                                       data-fv-field="email">
                                            </div>
                                        ...
                                        <div class="form-group form-group-lg has-feedback">
                                            ...
                                            <div>
                                                <textarea type="text" 
                                                          ...
                                                          tabindex="3" id="address_0" 
                                                          name="note" 
                                                          placeholder="Ví dụ: Sản phẩm màu đỏ, giao hàng trong giờ hành chính...." 
                                                          data-fv-notempty="true" 
                    ...
                    <div class="box__body">
                        ...
                        <div class="order-items">
                            <div class="order-item">
                                <div class="name">
                                    <a target="_blank" 
                                       href="{{ route('detailProduct', [ app('ClassCommon')->formatText($row->name), $row->id ]) }}"
                                       title="{{ $row->name }}">
                                        {{ $row->name }}
                                    </a>
                                </div>
