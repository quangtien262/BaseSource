<div class="modal-settings modal modal-right fade" tabindex="-1" role="dialog">
    ...
    <form method="post" action="{{ route('changeSetting') }}">
        ...
        <div class="modal-content">
            ...
            <hr>
            <button class="btn btn-default btn-raised" type="submit" data-toggle-fullscreen="">Lưu Setting</button>
            <hr>
            ...
            <p>Change language</p>    
            <div class="btn-group">
                <button class="btn btn-default btn-block btn-raised" type="button" data-toggle="dropdown">English</button>
