<?php
define('LAYOUT_BACKEND_01', 'Layouts.backend');
define('LAYOUT_BACKEND_02', 'Layouts.backend');
define('LAYOUT_POPUP', 'Layouts.popup');
define('JSON_MENU_FILE', '../config/menu.json');
define('JSON_PERMISSION_FILE', '../config/permission.json');

define('DATA_USER', '/user/');

$_PERMISSION = array();
$_PERMISSION['VIEW_LIST_BANG_GIA'] = 'Xem danh sách bảng giá';
$_PERMISSION['VIEW_LIST_BAO_GIA'] = 'Xem danh sách báo giá ';
$_PERMISSION['VIEW_LIST_DAT_HANG'] = 'Xem danh sách đặt hàng';
$_PERMISSION['VIEW_LIST_MUA_HANG'] = 'Danh sách mua hàng';
$_PERMISSION['VIEW_LIST_PACKING_LIST'] = 'Xem Packing list';
$_PERMISSION['VIEW_LIST_DOI_TAC'] = 'Xem danh sách dối tác';
//return code
