...
class ProductsController extends Controller {
    ...
    public function listProduct($sluggable, $cateId) {
        ...
        $products = app('ClassProducts')->getProductByCategory($cateId, 6, $order);
    ...
    public function detail($sluggable, $pId) {
        ...
        foreach ($productsImages as $img) {
            $imgLarge .= '<a href="#" class=""><img width="400" height="400" itemprop="image" style="max-width: 100%;"  src="' . $img->image . '" alt="' . $product['vi']->name . '" /></a>';
