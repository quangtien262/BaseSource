...
<html >
    ...
    <head lang="en">
        ...
        <title>{{ $title or $config->title  }}</title>
        <meta http-equiv="Content-Language" content="vn"/>
        <meta name="description" content="{{ $description or $config->description  }}"/>
        <meta name="keywords" content="{{ $keyword or $config->keyword  }}"/>
    ...
    <body class="page-home {{\Request::route()->getName()}}">

        @include('Frontend.Elements.Layout.navTop')
        ...
        <div id="hd-container" class="hd-container">
            ...
            <div class="hd-menu hd-effect-4 visible-xs visible-sm">
                <div class="hd-menu-container">
                    ...
                    <nav class="side-nav">
                        {!! app('ClassCategory')->htmlMenuMobile() !!}
                    </nav>
                    <div class="hotline">
                    ...
                    <div class="hd-content-inner">
                        <div id="page-wrapper">
                            ...
                            <header id="header" class="header clearfix">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-2 header-cart-wrapper ">
                                                <ul class="header-cart">
                                                    <li class="nav-cart">
                                                        <a href="#" data-toggle="dropdown"><i class="hd hd-cart"></i><span class="circle">{{ \Cart::content()->count() }}</span> <span class="hidden-xs hidden-sm">Giỏ hàng</span></a>
                                ...
                                @include('Frontend.Elements.Layout.menu')
